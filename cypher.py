...
def data_preview_committee(tx, terms, ids, skip, limit, count):
    c = ""
...
def data_preview_employer(tx, terms, ids, skip, limit, count):
    c = ""
    if terms is not None and ids is not None and count is True:
        c+= "CALL { "
    if terms is not None:
...
def data_preview_job(tx, terms, ids, skip, limit, count):
    c = ""
    if terms is not None and ids is not None and count is True:
        c+= "CALL { "
    if terms is not None:
