...
def data_calculate_recipe_committee(tx, terms, ids, skip, limit, count):
    c = ""
    if terms is not None and ids is not None and count is True:
        c+= "CALL { "
    ...
    if ids is not None:
        ...
        if count is True:
            c+= "RETURN count(a) AS count "
        else:
            c+= "RETURN a.cmte_id AS cmte_id, a.cmte_nm AS cmte_nm "
    if terms is not None and ids is not None and count is True:
        c+= "RETURN sum(count) AS count } "
    c+= "SKIP $skip "
    c+= "LIMIT $limit"
...
def data_calculate_recipe_employer(tx, terms, ids, skip, limit, count):
    c = ""
    if terms is not None and ids is not None and count is True:
        c+= "CALL { "
    if terms is not None:
...
def data_calculate_recipe_job(tx, terms, ids, skip, limit, count):
    c = ""
    if terms is not None and ids is not None and count is True:
        c+= "CALL { "
    if terms is not None:
